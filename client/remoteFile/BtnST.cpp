...
#define BS_TYPEMASK_01 SS_TYPEMASK
...
void CButtonST::PreSubclassWindow() 
{
	...
	m_nTypeStyle = nBS & BS_TYPEMASK_01;
	...
	ModifyStyle(BS_TYPEMASK_01, BS_OWNERDRAW, SWP_FRAMECHANGED);
...
{
	UINT nNewType = (wParam & BS_TYPEMASK_01);
	...
	return DefWindowProc(BM_SETSTYLE,
		(wParam & ~BS_TYPEMASK_01) | BS_OWNERDRAW, lParam);
} // End of OnSetStyle
