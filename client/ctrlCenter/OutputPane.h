...
// Attributes
public:
	CDockPaneWnd<CListBox> m_wndOutput;
...
protected:
	...
	afx_msg void OnUpdateLogDeleteOne(CCmdUI* pCmdUI);
	afx_msg void OnUpdateLogClearAll(CCmdUI* pCmdUI);
	afx_msg void OnLogDeleteOne();
	afx_msg void OnLogClearAll();
	//}}AFX_MSG
	afx_msg void OnMessageClear(NMHDR *pNotifyStruct, LRESULT* pResult);
	DECLARE_MESSAGE_MAP()
};
